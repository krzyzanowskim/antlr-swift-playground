...
open class Swift3Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            RCURLY=136, RPAREN=137, RBRACK=138, COMMA=139, COLON=140, SEMI=141, 
            LT=142, GT=143, UNDERSCORE=144, BANG=145, QUESTION=146, AT=147, 
            AND=148, SUB=149, EQUAL=150, OR=151, DIV=152, ADD=153, MUL=154, 
            MOD=155, CARET=156, TILDE=157, Operator_head_other=158, Operator_following_character=159, 
            Implicit_parameter_name=160, Binary_literal=161, Octal_literal=162, 
            Decimal_literal=163, Pure_decimal_digits=164, Hexadecimal_literal=165, 
	...
	override open
	func getRuleNames() -> [String] { return Swift3Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return Swift3Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return Swift3Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return Swift3Lexer.modeNames }

	override open
	func getATN() -> ATN { return Swift3Lexer._ATN }


	public
	static let _serializedATN: String = Swift3LexerATN().jsonString
